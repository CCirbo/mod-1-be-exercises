...
RSpec.configure do |config|
 ...
 RSpec.describe ColoradoLottery do
    ...
    it 'it exists' do
        expect(@lottery).to be be_a(ColoradoLottery)
    end

    xit "has no registered_contestants by default" do
        expect(@lottery.registered_contestants).to eq({})
    end

    xit 'has no lottery_winners by default' do
        expect(@lottery.winners).to eq([])
    end

    xit 'has no lottery_current_winners by default' do
